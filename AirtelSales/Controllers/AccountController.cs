...
namespace AirtelSales.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (userInfo == null)
            {
                ViewBag.EmailNotConfirmed = "Please check your email. It does not exist";
                return View(model);
            }
            ...
            //{
            //    ViewBag.EmailNotConfirmed = "Your Account has been disabled. Please Contact Your Admin to enable your Account";
            //    return View(model);
            //}
        ...
        //    {
        //        fullName = db.RegionalManagers.Where(m => m.UserId == id).FirstOrDefault().Name;
        //    }
        //    else if (Role == "ZonalManager")
        //    {
        //        fullName = db.ZonalManagers.Where(m => m.UserId == id).FirstOrDefault().Name;
        //    }
        //    else if (Role == "AreaManager")
        //    {
        //        fullName = db.AreaManagers.Where(m => m.UserId == id).FirstOrDefault().Name;
        //    }
        //    else if (Role == "MarketDeveloper")
        //    {
        //        fullName = db.RegionalManagers.Where(m => m.UserId == id).FirstOrDefault().Name;
        //    }
        ...
        //    ViewBag.Areas = new SelectList(db.Areas.OrderBy(s => s.Name), "Id", "Name");
        //    ViewBag.Regions = new SelectList(db.Regions.OrderBy(s => s.Name), "Id", "Name");
        //    ViewBag.Zones = new SelectList(db.Zones.OrderBy(s => s.Name), "Id", "Name");
        //    return View();
        //}


        //[HttpPost]
        //public ActionResult UpdateUserRole(Profile userProfile, string id, string Role, string OldRole)
        //{
        //    if (ModelState.IsValid)
        //    {
        //        var user = db.AspNetUsers.Find(id);
        ...
        //        var newUser = db.AspNetUsers.Find(id);
        //        newUser.Role = userProfile.Role;
        //        var result1 = UserManager.AddToRole(id, userProfile.Role);
